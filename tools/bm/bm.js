...
function initBMPanel(){
  ...
  ['bm-total','bm-seg1-val','bm-seg1-lbl','bm-seg1-brace','bm-seg1-divlbl','bm-seg2-val','bm-seg2-lbl','bm-seg2-brace','bm-seg2-divlbl','bm-seg3-val','bm-seg3-lbl','bm-seg3-brace','bm-seg3-divlbl'].forEach(id=>document.getElementById(id)?.addEventListener('input',autoPreviewBM));
}
